...
global $Connection;
	if (isset($_POST["Submit"])) {
		...
		$Password=$_POST["pass"];
			...
			$QueryLogin="SELECT * FROM user WHERE name='$UserName' AND pass='$Password'";//'OR'1'='1
			...
			if ($admin=mysqli_fetch_assoc($ExecuteLogin)) {
				...
				$_SESSION['ErrorMessage']="Invalid Username And Password, Login Faild";
			...
			<div class="wrap-login100 p-l-85 p-r-85 p-t-55 p-b-55">
				...
				<form class="login100-form validate-form flex-sb flex-w" action="index.php" method="POST">
					...
					<div class="container-login100-form-btn">
						<input class="login100-form-btn" value="Login" name="Submit" type="Submit">
					</div>
